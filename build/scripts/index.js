...
function onTouchStart(event2) {
  ...
  const startY2 = touches.currentY;
...
function Zoom(_ref) {
  ...
  function enable() {
    ...
    swiper2.wrapperEl.addEventListener("pointermove", onTouchMove3, activeListenerWithCapture);
  }
  function disable() {
    const zoom = swiper2.zoom;
    if (!zoom.enabled)
    ...
    swiper2.wrapperEl.removeEventListener("pointermove", onTouchMove3, activeListenerWithCapture);
  }
  on("init", () => {
...
function throttle(callback, delayBetweenFrames) {
  ...
  return (...rest) => {
    ...
    if (now2 - lastTime >= delayBetweenFrames) {
...
var onTouchStart2 = (evt) => {
  evt.preventDefault();
  isDragging = true;
  startY = evt.touches[0].clientY;
};
var onTouchMove2 = throttle((evt) => {
  evt.preventDefault();
  if (isDragging) {
...
function addDragButtonHandler() {
  dragButton.addEventListener("touchstart", onTouchStart2);
  dragButton.addEventListener("touchmove", onTouchMove2);
  dragButton.addEventListener("touchend", onTouchEnd2);
}
function removeDragButtonHandler() {
  dragButton.removeEventListener("touchstart", onTouchStart2);
  dragButton.removeEventListener("touchmove", onTouchMove2);
  dragButton.removeEventListener("touchend", onTouchEnd2);
}
